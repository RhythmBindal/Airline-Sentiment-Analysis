...
Original file is located at
    https://colab.research.google.com/drive/15bxQI53ZtjpJPETLycaahW68_WT-nBDE
"""
...
X = data['text'].apply(preprocessor)
...
dump(neural_net_pipeline, 'sentiment_analysis.joblib')
